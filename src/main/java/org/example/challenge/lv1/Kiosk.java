            ...
            while (true) {
                if (num1 == 1) {
                    ...
                    if (num2 > 0 && num2 < 5) {
                        ...
                        int num3 = sc.nextInt();
                        if (num3 == 1) {
                            cart.addCartItem(new CartItem(category.getName(), new BigDecimal(category.getPrice()), category.getDescription()));
                    ...
                    break;
                } else if ((num1 == 4 || num1 == 5) && !cart.getCartItems().isEmpty()) {
                    if (num1 == 4) {
